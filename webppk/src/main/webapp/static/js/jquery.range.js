	...
	jRange.prototype = {
		...
		template: '<div class="slider-container">\
			<div class="back-bar">\
				...
				<div class="pointer-label"><span>123456</span></div>\
...
$(function(){
	$('.foumt-rojectiondistance').jRange({
		from: 0,
		to: 100,
		step: 1,
		scale: [0,100],
