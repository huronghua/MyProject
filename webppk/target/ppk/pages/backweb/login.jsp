...
<link href="../../ppk/static/backweb/css/bootstrap.css" rel="stylesheet">
<link rel="stylesheet" href="../../ppk/static/backweb/css/global.css">
<link href="../../ppk/static/backweb/css/layout.css" rel="stylesheet">
...
<body class="loginbady">
	<div class="logintop">
		<div class="logintoptitle text-center">
			<div class="logintoplogo">
				<img src="../../ppk/pages/backweb/images/logo.png">
			</div>
			...
			<form name="form1" method="post" action="">
				<div class="loginfron_irem  clearboth">
					...
					<div class="pull-left from_inp">
						<label for="loginname"> <input type="text" name="loginname"
							id="loginname" class="from_bonw" placeholder="请输入用户名">
						</label>
					</div>
				</div>
				<div class="loginfron_irem  clearboth">
					...
					<div class="pull-left from_inp">
						<label for="password"> <input type="text" name="password"
	...
	<div class="login_cpy">
		...
		<p>技术支持上海爱护我信息技术有限公司 沪ICP备12018714号-17</p>
	</div>
</body>
</html>
