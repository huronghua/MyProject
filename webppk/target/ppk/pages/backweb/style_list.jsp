    ...
    <head>
        ...
        <script type="text/javascript">
                    ...
                    columns: [[
                            ...
                            {field: 'CreatTime', title: '创建时间', width: 250, align: 'center'},
                            {
                                ...
                                formatter: function (value, row, index) {
                                    ...
                                    {
                                        use1 = '启用';
                                        f = '<a id="use" onclick="editUse(' + index + ')">启用</a>';
                                    } else
                                    {
                                        use1 = '不启用';
                                        f = '<a id="use" onclick="editUse(' + index + ')">不启用</a>';
                                    }

                                    var d = '<a href="#" onclick="deleteRow(' + index + ')" class="red btn" >删除</a>';
                                    return e + f + d;
                                }
                            }
                        ]],
            ...
            function editUse(index) {
                var row = $('#txtstylename').datagrid('getRows');
                //alert(row[index].ID);
    			$.ajax({
    				type : "POST",
    				url : '../../style_use',
            ...
            function editstyle(index){
                var row = $('#styletable').datagrid('getRows');
                window.location.href = "style_edit.jsp?styleid=" + row[index].ID;
            }
    ...
    <body class="navbady">
        ...
        <div class="container_min">
            <div class="listoperation clearboth">
                <a href="style_edit.jsp" class=" pull-left listoperation_add">
                ...
                <div class=" pull-left listoperation_search form-group">
                    <form action="" method="get">
                        <div class="pull-left form_item_inline">
                            <label id="lblstyle" name="lblstyle" for="select">样式名称：</label>
