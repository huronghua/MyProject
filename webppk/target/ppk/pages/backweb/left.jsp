...
<body class="navleft">
   <div class="navleft_grep">
      ...
      <ul>
         <li class="clearboth">
            <a href="user_list.html" class="clearboth" target="navpang" >
                <i class="pull-left icon-iconfont-yonghu"></i>
                <span class="pull-left">用户管理</span>
             </a>
         </li>
         <li class="clearboth">
            <a href="role_list.html" class="clearboth" target="navpang">
                <i class="pull-left icon-iconfont-logo14"></i>
                <span class="pull-left">角色管理</span>
             </a>
         </li>
         <li class="clearboth">
            <a href="journal_list.html" class="clearboth" target="navpang">
         ...
         <li class="clearboth">
            <a href="member_list.html" class="clearboth" target="navpang">
                <i class="pull-left icon-iconfont-huiyuan"></i>
                <span class="pull-left ">会员管理</span>
             </a>
         </li>
         <li class="clearboth">
            <a href="ad_list.html" class="clearboth" target="navpang">
